...
namespace ngfx {
    ...
    public:
        void create(VKGraphicsContext* ctx, const void* data, uint32_t size, VkBufferUsageFlags bufferUsageFlags,
    ...
    protected:
        ...
        void initDescriptorSet(VkDescriptorPool descriptorPool, VkDescriptorSetLayout descriptorSetLayout, VkDescriptorType descriptorType,
