...
GraphicsPipeline::create(GraphicsContext* graphicsContext, const State& state,
  ...
  VKGraphicsPipeline::State vkState = {
      ...
      state.blendEnable,
      VkBlendFactor(blendParams.srcColorBlendFactor),
      VkBlendFactor(blendParams.dstColorBlendFactor),
      VkBlendFactor(blendParams.srcAlphaBlendFactor),
      VkBlendFactor(blendParams.dstAlphaBlendFactor),
      VkBlendOp(blendParams.colorBlendOp),
      VkBlendOp(blendParams.alphaBlendOp),
      ...
      VkStencilOp(stencilParams.frontStencilFailOp),
      VkStencilOp(stencilParams.frontStencilDepthFailOp),
      VkStencilOp(stencilParams.frontStencilPassOp),
      VkCompareOp(stencilParams.frontStencilFunc),
      VkStencilOp(stencilParams.backStencilFailOp),
      VkStencilOp(stencilParams.backStencilDepthFailOp),
      VkStencilOp(stencilParams.backStencilPassOp),
      VkCompareOp(stencilParams.backStencilFunc),
