...
#define VK_SURFACE_EXTENSION_NAMES VK_KHR_XCB_SURFACE_EXTENSION_NAME, VK_KHR_XLIB_SURFACE_EXTENSION_NAME
...
#define PREFERRED_DEVICE_TYPE VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU //VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU
