...
protected:
  virtual void initFromByteCode(id<MTLDevice> device, void *data,
                                uint32_t size);
};
MTL_CAST(ShaderModule);

class MTLVertexShaderModule : public VertexShaderModule,
                              public MTLShaderModule {
public:
  virtual ~MTLVertexShaderModule() {}
};
MTL_CAST(VertexShaderModule);

class MTLFragmentShaderModule : public FragmentShaderModule,
                                public MTLShaderModule {
public:
...
class MTLComputeShaderModule : public ComputeShaderModule,
                               public MTLShaderModule {
public:
