...
namespace ngfx {
    ...
    public:
        ...
        D3DDevice d3dDevice;
        ComPtr<ID3D12CommandAllocator> d3dDrawCommandAllocator, d3dCopyCommandAllocator, d3dComputeCommandAllocator;
        ...
        D3DRenderPass *d3dDefaultRenderPass = nullptr, *d3dDefaultOffscreenRenderPass = nullptr;
