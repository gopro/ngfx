...
namespace ngfx {
    ...
    class D3DVertexShaderModule : public VertexShaderModule, public D3DShaderModule {
    public:
        virtual ~D3DVertexShaderModule() {}
    };
    D3D_CAST(VertexShaderModule);

    class D3DFragmentShaderModule : public FragmentShaderModule, public D3DShaderModule {
    public:
        virtual ~D3DFragmentShaderModule() {}
    };
    D3D_CAST(FragmentShaderModule);

    class D3DComputeShaderModule : public ComputeShaderModule, public D3DShaderModule {
    public:
